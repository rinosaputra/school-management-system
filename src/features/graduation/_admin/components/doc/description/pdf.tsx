...
import { pdfTw } from '@/components/pdf/tw';
import { PDFText, PDFView } from '@/components/pdf/component';
...
const GraduationAdminDocDescriptionPDF = ({ result }: Record<"result", GraduationWithStudentOutputSchema | null>): React.ReactElement => {
  console.log(result)
  return (
    <Document>
      <Page size={
      ...
      } style={pdfTw(`p-[${marginX}mm] pb-[10mm] pt-[40mm] font-sans text-[${fontSize}px]`)}>
